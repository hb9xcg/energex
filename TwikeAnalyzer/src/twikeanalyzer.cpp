...
void TwikeAnalyzer::createActions()
{
...
void TwikeAnalyzer::createMenus()
{
...
void TwikeAnalyzer::createToolBars()
{
...
void TwikeAnalyzer::createStatusBar()
{
...
void TwikeAnalyzer::loadFile(const QString &fileName)
{
      QFile file(fileName);
...
bool TwikeAnalyzer::saveFile(const QString &fileName)
{
      QFile file(fileName);
...
void TwikeAnalyzer::setCurrentFile(const QString &fileName)
{
      curFile = fileName;
...
QString TwikeAnalyzer::strippedName(const QString &fullFileName)
{
