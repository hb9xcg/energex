...
public class Message {
	...
	static final	short GESCHWINDIGKEIT = 0x00FE;
	static final	short TAGESKILOMETER  = 0x00FF;
	
	static final	short COMMAND_INDEX   = 3;
	static final	short PARAMETER_INDEX = 5;
