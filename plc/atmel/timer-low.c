...
ISR(SIG_OUTPUT_COMPARE2) {
#endif
	/* ----- TIMER ----- */
	uint32_t ticks = tickCount.u32;	// TickCounter [400 us] erhoehen
	ticks++;
	 ...
	 * (sofort) wieder hierher zurueck, sondern es koennte auch ein Thread weiterlaufen, der
