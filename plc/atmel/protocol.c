...
static void protocol_receiveGroup(void);
...
void protocol_receiveGroup(void)
{
	uint16_t value, binfo, voltage;
	int16_t	current;
	...
	battery_set_info(binfo);
	battery_set_current(current);
