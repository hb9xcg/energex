...
#define BootStart          0UL  // 220 bytes
//#define BootStart          0xf800UL worked
...
//password
#if (LEVELMODE == 0)
unsigned char ConnectKey[] = {0x41, 0x56, 0x52, 0x50, 0x4C};
#endif
